            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <button class="btn btn-pill btn-info btn-light" type="button" style="font-size: 15px;display: inline-block"><i class="fa fa-qrcode" style=" margin-right: 10px;align-items: center"></i> Generate Code</button>
                    </div>
                    <div class="card-body">
