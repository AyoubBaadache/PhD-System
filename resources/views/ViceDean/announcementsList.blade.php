            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <a class="btn btn-pill btn-info btn-light" href={{url('vd/createAnnouncements')}} type="button" style="font-size: 15px;display: inline-block"><i class="fa fa-share-alt" style=" margin-right: 10px;align-items: center"></i> Make Announcement</a>
                    </div>
                    <div class="card-body">
