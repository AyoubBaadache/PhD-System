<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="{{ url('participant/home') }}"><img class="img-fluid for-light"
        ...
        <nav class="sidebar-main">
            ...
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="back-btn"><a href="{{  url('participant/home')}}"><img class="img-fluid"
                                                                                     src="{{ asset('assets/images/logo/logo-icon.png') }}"
                                                                                     alt=""></a>
